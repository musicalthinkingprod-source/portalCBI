...
class PiarController extends Controller
{
    ...
    public function imprimirTodos(string $codigo)
    {
        ...
        $matsExcluidas = [24, 31, 35, 36, 124, 135, 153]; // Urbanidad y Cívica, Proyectos, Cátedra de Paz, English Acquisition Proyecto (materia sombra), Urbanidad y Cívica PE, Cátedra de Paz PE, Pensamiento Lógico
