...
Route::middleware(['auth'])->group(function () {
    ...
    // ── Suplencias: SuperAd + Coordinación Académica (COR001) y Convivencia (COR002) ──
    Route::middleware('profile:SuperAd,COR001,COR002')->group(function () {
        ...
        Route::get('/asistencia-personal/suplencias-dia',    [AsistenciaPersonalController::class, 'suplenciasDia'])    ->name('asistencia-personal.suplencias_dia');
    });
