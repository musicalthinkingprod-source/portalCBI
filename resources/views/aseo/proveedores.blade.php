...
@section('header', 'Aseo · Proveedores')
...
<p class="mb-4 text-sm text-gray-500">Los proveedores se comparten con el módulo de uniformes.</p>

<div class="grid lg:grid-cols-3 gap-6">
    <div class="bg-white rounded-xl shadow p-5 h-fit">
        <h3 class="font-semibold text-gray-700 mb-4">Nuevo proveedor</h3>
        <form method="POST" action="{{ route('aseo.proveedores.store') }}" class="space-y-3">
            @csrf
            <div>
