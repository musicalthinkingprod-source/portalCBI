            ...
            @if($puedeObservar)
                ...
                <div class="mt-3 space-y-2">
                    @if($estadoActual === 'revision' || $estadoActual === 'con_observaciones')
                        {{-- El form de aprobar se declara fuera de #form-caract-dir (ver abajo)
                             para evitar formularios anidados; el botón lo referencia con form=. --}}
                        <button type="submit" form="form-aprobar-caract-dir"
...
<form id="form-aprobar-caract-dir" method="POST"
      action="{{ route('piar.aprobar.caract.dir', $estudiante->CODIGO) }}">
    @csrf
</form>
@endif
