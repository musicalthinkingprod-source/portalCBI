    ...
    <div class="max-w-2xl space-y-6">
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <div class="px-5 py-3 bg-gray-700 text-white">
                ...
                <p class="text-gray-300 text-xs mt-0.5">Eliminar un lote borra todos sus registros de facturación</p>
            </div>
            @if($lotes->isEmpty())
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-right">
                            <form method="POST"
                                action="{{ route('importacion.facturacion.lote.destroy', $l->lote_importacion) }}"
