...
@section('header', 'Certificados de Notas')
...
<div class="max-w-3xl">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl px-5 py-3 mb-5 text-sm text-blue-800">
        Genera el <strong>Consolidado de notas individual</strong> de un estudiante a partir de las notas registradas en el año seleccionado.
    </div>
    ...
    <div class="flex gap-1 mb-5">
        ...
        @endphp
        <a href="{{ route('certificados.buscar', $params) }}"
    ...
    <div class="bg-white rounded-xl shadow p-5 mb-6">
        ...
        <form method="GET" action="{{ route('certificados.buscar') }}" class="flex gap-3">
        ...
        <ul class="divide-y divide-gray-100">
            ...
            <li class="flex items-center justify-between px-5 py-3 hover:bg-gray-50">
                ...
                <div class="flex items-center gap-2 shrink-0">
                    <a href="{{ route('certificados.ver', ['codigo' => $est->CODIGO, 'anio' => $anio]) }}"
                        target="_blank"
                    ...
                    <a href="{{ route('certificados.ver', ['codigo' => $est->CODIGO, 'anio' => $anio, 'print' => 1]) }}"
                        target="_blank"
