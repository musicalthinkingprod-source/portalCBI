...
@endphp
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
        ...
        <form method="GET" action="{{ route('facturacion.index') }}">
            {{-- Preservar sort activo en el form --}}
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                    ...
                    <tr class="bg-white border-b border-gray-200">
                        ...
                        <td class="px-2 py-1">
                            <input type="number" name="orden" value="{{ request('orden') }}"
                                placeholder="Filtrar…"
                                class="w-full border border-gray-300 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400">
                        </td>
                        <td class="px-2 py-1">
                            <input type="text" name="codigo_concepto" value="{{ request('codigo_concepto') }}"
                                placeholder="Filtrar…"
                                class="w-full border border-gray-300 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400">
                        </td>
                        <td class="px-2 py-1">
                            <input type="text" name="centro_costos" value="{{ request('centro_costos') }}"
                                placeholder="Filtrar…"
                                class="w-full border border-gray-300 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400">
                        </td>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="9" class="px-4 py-6 text-center text-gray-400 text-sm">Sin registros de facturación.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
