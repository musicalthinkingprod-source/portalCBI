...
<div class="max-w-2xl">
    <form method="POST" action="{{ route('documentacion.update', $documento) }}" class="space-y-5">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="descripcion" rows="2"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm resize-none">{{ old('descripcion', $documento->descripcion) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="w-32">
                    ...
                    <input type="number" name="orden" value="{{ old('orden', $documento->orden) }}" min="0" max="999"
                ...
                <div class="flex items-center gap-2 mt-4">
                    ...
                    <input type="checkbox" name="activo" id="activo" value="1"
                        {{ old('activo', $documento->activo ? '1' : '0') == '1' ? 'checked' : '' }}
