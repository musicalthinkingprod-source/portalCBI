...
@section('header', 'Matricular Nuevo Estudiante')
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden mb-6">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="{{ $campo }}" value="{{ old($campo) }}"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                @endforeach
                ...
                <div>
                    ...
                    <input type="date" name="FECH_NACIMIENTO" value="{{ old('FECH_NACIMIENTO') }}"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
